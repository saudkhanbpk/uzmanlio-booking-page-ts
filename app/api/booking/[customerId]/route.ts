...
export async function POST(
  ...
  try {
    ...
    const bookingDataString = formData.get("bookingData") as string | null;
    ...
    const backendUrl =
      `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:4000"}/api/booking/customers/68e3af0fda607cde106d94d4/form`;
